...
ZUX_ENABLE_CATEGORY(ZUX_UIApplication); \
...
ZUX_ENABLE_CATEGORY(ZUX_UINavigationController); \
ZUX_ENABLE_CATEGORY(ZUX_UINavigationBar); \
ZUX_ENABLE_CATEGORY(ZUX_UITabBar); \
ZUX_ENABLE_CATEGORY(ZUX_UIBarItem); \
ZUX_ENABLE_CATEGORY(ZUX_UITabBarItem); \
ZUX_ENABLE_CATEGORY(ZUX_UIBarButtonItem); \
